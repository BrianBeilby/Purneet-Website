export const links = [ //Links for the navbar 
  ...
  export const episodes: Episode[] = [
    ...
    { id: 2, title: 'Episode 2 Natasha Palumbo ', description: 'The Second Episode  episode featuring Professor P, aka Natasha Palumbo. She is a very impressive individual ', link: 'https://youtu.be/jymsKtKOytE'},
  ];
